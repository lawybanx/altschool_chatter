...
const RegisterForm = ({ handleAuthentication, signingIn, error, setError }) => {
        ...
        <VStack spacing={4} align='stretch'>
          ...
          <Center spacing={10}>
            <Button
              ...
              leftIcon={<FcGoogle />}
              onClick={() =>
                handleAuthentication(null, null, null, googleProvider)
              }
            >
              <Center>
          ...
          <Center spacing={10}>
            <Button
              ...
              leftIcon={<FaGithub />}
              onClick={() =>
                handleAuthentication(null, null, null, githubProvider)
              }
            >
              <Center>
